...
void main() {
  runApp(MyApp());
  // Call configLoading() trong main function để xly các vde sau:
  // - Chạy được option custom
  // - Khi 1 hiệu ứng đang load thì vẫn có thể click các button trên màn hình - click được button dismiss để stop hiệu ứng .show
  configLoading();
}
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              // Set EasyLoadingIndicatorType - hiệu ứng trên method EasyLoading.show
              Padding(
