 ...
 */
// Use the numbered horizontal scrolling bar to switch between 29 different examples.
...
class DemoConstraints extends StatelessWidget {
  const DemoConstraints({super.key});
  ...
  Widget build(BuildContext context) {
    return Center(
      child: ConstrainedBox(
        ...
        child: Container(color: red, width: 70, height: 10),
      ),
    );
  }
}
